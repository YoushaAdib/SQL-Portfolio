-- SQL Project with IDS-IPS (Time Series) Dataset 
-- MD YOUSHA ADIB

-- ATK LABEL SUMMARY [YES]
SELECT LABEL, COUNT(*), MAX (FWD_PKTS), MIN (FWD_PKTS)
FROM IDS_1
GROUP BY LABEL

-- PROTOCOL SUMMARY [NO]
SELECT PROTOCOL, COUNT (*) AS NUM_CONNECTION
FROM IDS_1
GROUP BY PROTOCOL
...
-- DRILL DOWN INTO FLOW DURATION AND ATTACK PACKETS
